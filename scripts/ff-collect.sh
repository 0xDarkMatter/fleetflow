...
# Defined BEFORE the EXIT trap on purpose: the --check-main-clean guard path
# exits early, and a trap that fires then must not call an undefined name
# (found live 2026-08-25 - "ff_run_summary: command not found" on stderr).
