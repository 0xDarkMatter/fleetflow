...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 498 hermetic assertions over the scripts, dashboard
...
`adr-lint` runs inside the 498-assertion test gate: a malformed decision
...
- ✅ Suite grown to 498 hermetic assertions.
...
498 assertions over the scripts, monitor, dashboard wiring, and import/resume
