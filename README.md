...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 492 hermetic assertions over the scripts, dashboard
...
`adr-lint` runs inside the 492-assertion test gate: a malformed decision
...
- ✅ Suite grown to 492 hermetic assertions.
...
492 assertions over the scripts, monitor, dashboard wiring, and import/resume
