...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 482 hermetic assertions over the scripts, dashboard
...
`adr-lint` runs inside the 482-assertion test gate: a malformed decision
...
- ✅ Suite grown to 482 hermetic assertions.
...
482 assertions over the scripts, monitor, dashboard wiring, and import/resume
