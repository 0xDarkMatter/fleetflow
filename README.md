...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 592 hermetic assertions over the scripts, dashboard
...
[39 ADRs](docs/adr/) covering everything from why the dashboard is one
...
`adr-lint` runs inside the 592-assertion test gate: a malformed decision
...
592 assertions over the scripts, monitor, dashboard wiring, and import/resume
