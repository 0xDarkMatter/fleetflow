...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 480 hermetic assertions over the scripts, dashboard
...
`adr-lint` runs inside the 480-assertion test gate: a malformed decision
...
- ✅ Suite grown to 480 hermetic assertions.
...
480 assertions over the scripts, monitor, dashboard wiring, and import/resume
