...
- **Safety as defaults.** Worktree isolation, escape guard on the primary
  ...
  teardown.
- **A tested gate.** 507 hermetic assertions over the scripts, dashboard
...
`adr-lint` runs inside the 507-assertion test gate: a malformed decision
...
- ✅ Suite grown to 507 hermetic assertions.
...
507 assertions over the scripts, monitor, dashboard wiring, and import/resume
